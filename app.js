...
App = function()
{
    ...
    this.load = function()
    {
        ...
        wade.loadImage('images/yellow.png');
		 wade.loadImage('images/grey.png');
        ...
        wade.loadImage('images/yellowGlow.png');
		 wade.loadImage('images/greyGlow.png');
		...
		wade.loadImage('images/buttonPlayB.png');
    ...
    this.game = function()
    {
        ...
        menu.addSprite(shareBackSprite, {x:-wade.getScreenWidth()/2 + 175, y:wade.getScreenHeight()/2 - 125});
		 ...
		 // Create play button B -Desi
		var playButtonSprite = new Sprite('images/buttonPlay.png', this.layers.board);
        ...
        playButton.onMouseUp = function()
        {
            ...
            wade.addSceneObject(this.theGame, true, {match3:
            {
                ...
                cellSize: {x:85, y:85},
                margin: 5,
                items: [{normal: 'images/red.png', special:'images/redGlow.png', probability:20},
                    {normal: 'images/blue.png', special:'images/blueGlow.png', probability:20},
                    {normal: 'images/green.png', special:'images/greenGlow.png', probability:20},
                    {normal: 'images/yellow.png', special:'images/yellowGlow.png', probability:20},
					{normal: 'images/grey.png', special:'images/greyGlow.png', probability:20}],
		...
		playButtonSprite.setDrawFunction(wade.drawFunctions.resizeOverTime_ (30, 16, 301, 156, 0.3, playButtonSprite.getDrawFunction(), function()	
        {
            ...
            creditsButton.setPosition(-wade.getScreenWidth()/17 + 175, wade.getScreenHeight()/2 - 75);
            ...
            if(self.socialEnabled)
            {
                ...
                {
                    open('https://www.facebook.com/housepetsgame/photos_stream?tab=photos_albums#', '_blank');
                };
    ...
    this.credits = function()
    {
        ...
        // Credits
            var theGang = new TextSprite('The Squad','72px ArtDept1', 'white', 'center', this.layers.front);
        theGang.setShadow('#000000', 3, 4, 4);
        var workerBees = new TextSprite('Alyson Jing \n\nDaisy Yovcheva \n\nKara Pfaff  \n\nVentzi Vassilev \n\nYaro Grigoriev','46px ArtDept1', 'Lime', 'center', wade.app.layers.front);
        workerBees.setShadow('#000000', 1, 2, 2);
        var textObject = new SceneObject(theGang);
        textObject.addSprite(workerBees, {x:10, y: 95});
        textObject.setPosition(0, -wade.getScreenHeight()/2 + 80);

        // Add clockwork chilli link
     var soundCredit = new TextSprite('Track: \"Felipe\"\n\nBy Vers Cubana','32px ArtDept1', 'white', 'center', this.layers.front);
        soundCredit.setShadow('#000000', 1, 2, 2);
        textObject.addSprite(soundCredit, {x:0, y: 590});

        
        var soundLink = new TextSprite('','32px ArtDept1', 'blue', 'center', this.layers.front);
            ...
            youScoredSprite.setDrawFunction(wade.drawFunctions.fadeOpacity_(0.0, 1.0, 1.0, timeOutSprite.getDrawFunction(), function()
            {
                ...
                scoreSprite.setDrawFunction(wade.drawFunctions.fadeOpacity_(0.0, 1.0, 1.0, scoreSprite.getDrawFunction(), function()
                {
                    ...
                    if(self.socialEnabled)
                    {
                        ...
                        googleObj.onMouseUp = function()
                        {
                            open('https://plus.google.com/u/2/117504484494856319526/posts', '_blank');
                        };
   ...
   /**
    ...
    this.game = function()
    {
        ...
        menu.addSprite(shareBackSprite, {x:-wade.getScreenWidth()/2 + 175, y:wade.getScreenHeight()/2 - 125});
		 ...
		 // Create play button B -Desi
		var playButtonSpriteB = new Sprite('images/buttonPlayB.png', wade.app.layers.front);
        var playButtonB = new SceneObject(playButtonSprite);		
        playButtonB.onMouseUp = function()
        {
            wade.clearScene();
            if(!self.musicMuted)
            {
        ...
        playButtonB.setPosition(0, 160);		
		playButtonSpriteB.setDrawFunction(wade.drawFunctions.resizeOverTime_ (30, 16, 301, 156, 0.3, playButtonSpriteB.getDrawFunction(), function()	
        {
            // Create credits button
            var creditsButtonSprite = new Sprite('images/buttonCredit.png', self.layers.front);
            var creditsButton = new SceneObject(creditsButtonSprite);
            ...
            if(self.socialEnabled)
            {
                ...
                googleObj.onMouseUp = function()
                {
                    open('https://plus.google.com/u/0/117504484494856319526/posts', '_blank');
                };
                googleObj.setPosition(-wade.getScreenWidth()/2 + 95, wade.getScreenHeight()/2 - 75);
                wade.addSceneObject(googleObj, true);
